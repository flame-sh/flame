...
class GrpcServiceManagerStub(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def __init__(self, channel):
        ...
        self.RegisterService = channel.unary_unary(
                '/flame.GrpcServiceManager/RegisterService',
                request_serializer=shim__pb2.RegisterServiceRequest.SerializeToString,
                response_deserializer=shim__pb2.RegisterServiceResponse.FromString,
                _registered_method=True)


class GrpcServiceManagerServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_GrpcServiceManagerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RegisterService': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=shim__pb2.RegisterServiceRequest.FromString,
                    response_serializer=shim__pb2.RegisterServiceResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'flame.GrpcServiceManager', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('flame.GrpcServiceManager', rpc_method_handlers)
...
class GrpcServiceManager(object):
    ...
    def RegisterService(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/flame.GrpcServiceManager/RegisterService',
            shim__pb2.RegisterServiceRequest.SerializeToString,
            shim__pb2.RegisterServiceResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
